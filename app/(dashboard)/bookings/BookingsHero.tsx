...
export default function BookingsHero({ roomCount }: { roomCount: number }) {
  return <div className="hub-page-heading">
    <div><p className="hub-eyebrow">Make room for good work</p><h1>Your next great meeting<span className="hub-red">.</span></h1><p>{roomCount} spaces to connect, collaborate and get things moving.</p></div>
