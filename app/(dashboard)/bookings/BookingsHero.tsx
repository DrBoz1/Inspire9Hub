...
// A deliberately always-dark "hero" panel (independent of site theme), same
// convention as the induction-gate card on this page and the assistant's
// chat header — gives the booking page one strong visual anchor instead of
