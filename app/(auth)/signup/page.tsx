        ...
        <AuthFormMotion className="relative mx-auto w-full max-w-sm">
          ...
          <div className="mb-8 space-y-1.5">
            ...
            <p className="text-sm font-medium text-slate-400">
              Create your Inspire9 member account.
            </p>
          </div>
          ...
          <form action={signUp} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-300 pointer-events-none" aria-hidden />
                <input
                  name="name"
                  id="name"
                  type="text"
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-400">
              ...
              <Link href="/login" className="font-bold text-slate-700 hover:text-[#E31E24] transition-colors">
                Sign in
              </Link>
            </p>
          </div>
      ...
      <div className="hidden md:block md:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-10 text-white">
          ...
          <p className="mt-3 text-sm text-white/60 font-medium max-w-xs leading-relaxed">
            Join a community of makers, founders, and freelancers. Book your first space in minutes.
          </p>
          <div className="mt-6 flex flex-wrap gap-2">
            {["Coworking", "Meeting Rooms", "Events", "Community"].map((tag) => (
              <span key={tag} className="rounded-full bg-white/10 px-3 py-1 text-[10px] font-bold text-white/70 backdrop-blur-sm border border-white/10">
                {tag}
              </span>
            ))}
          </div>
