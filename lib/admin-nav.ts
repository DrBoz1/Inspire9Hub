export type AdminIcon = "dashboard" | "insights" | "leads" | "memberships" | "compliance" | "bookings" | "spaces" | "members" | "announcements" | "staff";
...
const GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/memberships", label: "Memberships", icon: "memberships" },
